...
To analyze multi-GPU scalability of frameworks, AlexNet was trained on each framework with 1 GPU, 2 GPU, and 4 GPU.
...
\begin{figure*}[]
  \centering
  \subfloat[Torch execution time]{\includegraphics[width=.45\linewidth]{./figures/mg_torch}}
  \subfloat[Caffe execution time]{\includegraphics[width=.45\linewidth]{./figures/mg_caffe}}
  \hfil
  \subfloat[TensorFlow execution time]{\includegraphics[width=.45\linewidth]{./figures/mg_tf}}
  \caption{
