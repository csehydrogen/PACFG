...
\fontsize{20}{0}\selectfont{\textbf{Performance Analysis of CNN Frameworks\\
 for GPUs}}
\vspace{32pt}\par
\fontsize{10}{12}\selectfont{\textbf{Thanks to modern deep learning frameworks that exploit GPUs, convolutional neural networks (CNNs) have been greatly successful in visual recognition tasks. In this paper, we analyze the GPU performance characteristics of five popular deep learning frameworks: Caffe, CNTK, TensorFlow, Theano, and Torch in the perspective of a representative CNN model, AlexNet.\\
